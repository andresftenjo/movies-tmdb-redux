...
const MovieDetailPage = ({ movievideos, moviedetails }) => (
  <div className="movieDetailsContainer">
      ...
      <iframe frameBorder="0" scrolling="no" width="100%" height="400px" type="text/html" src={`https://www.youtube.com/embed/${movievideos.key}?autoplay=1&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0`}></iframe>
      </div>
